...
void cube::AdaptionWidget::vfunc_0(float *param_1,float *param_2,int param_3);
...
void cube::AdaptionWidget::vfunc_1(float *param_1,float *param_2,int param_3);
