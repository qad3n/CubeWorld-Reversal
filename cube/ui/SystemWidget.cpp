// SystemWidget (ui) — cube. 2 functions. Bodies = Ghidra pseudo-C.
#include "SystemWidget.h"

/* cube::SystemWidget::ctor_0 @ 00587660 */

void cube::SystemWidget::ctor_0(undefined4 param_1,undefined4 param_2,undefined4 param_3)
...
/* cube::SystemWidget::vfunc_1 @ 00587710 */

void cube::SystemWidget::vfunc_1(void)

{
  ...
  if (fontLoaded != 0) {
    ...
    *(undefined4 *)(self + 0x160) = 0xffffffff;
    ...
    local_28 = 0x3f800000;
    uVar4 = 0x41f00000;
    fVar3 = (float10)security_cookie_guard_b(0x41f00000,0x41600000,0x40400000,0,0,0,puVar10,puVar12,puVar11,1,1
                                 );
    ...
    local_38 = 0;
    uVar4 = 0x41f00000;
    fVar3 = (float10)security_cookie_guard_b(0x41f00000,0x41600000,0,0,0,0,puVar10,puVar12,puVar11,1,1);
    Font_drawTextTransformed(local_74,(float)fVar3 * 0.5,uVar4,uVar5,uVar6,uVar7,uVar8,uVar9,puVar10,puVar12,
                 puVar11,uVar13,uVar14);
    local_8 = 0xffffffff;
    if (7 < local_60) {
    ...
    if (0.0 <= mouseY) {
      fVar3 = (float10)security_cookie_guard_b();
      if (((mouseY < (float)fVar3) && (40.0 <= mouseX)) && (mouseX < 70.0)) {
    ...
    local_50 = 0x3f800000;
    uVar4 = 0x42700000;
    fVar3 = (float10)security_cookie_guard_b(0x42700000,0x41600000,0x40400000,0,0,0,puVar10,puVar12,puVar11,1,1
                                 );
    Font_drawTextTransformed(local_74,(float)fVar3 * 0.5,uVar4,uVar5,uVar6,uVar7,uVar8,uVar9,puVar10,puVar12,
                 puVar11,uVar13,uVar14);
    local_8 = 0xffffffff;
    ...
    local_38 = 0;
    uVar4 = 0x42700000;
    fVar3 = (float10)security_cookie_guard_b(0x42700000,0x41600000,0,0,0,0,puVar10,puVar12,puVar11,1,1);
    Font_drawTextTransformed(local_74,(float)fVar3 * 0.5,uVar4,uVar5,uVar6,uVar7,uVar8,uVar9,puVar10,puVar12,
                 puVar11,uVar13,uVar14);
    local_8 = 0xffffffff;
    if (7 < local_60) {
    ...
    if (0.0 <= mouseY) {
      fVar3 = (float10)security_cookie_guard_b();
      if (((mouseY < (float)fVar3) && (70.0 <= mouseX)) && (mouseX < 100.0)) {
    ...
    local_50 = 0x3f800000;
    uVar4 = 0x42b40000;
    fVar3 = (float10)security_cookie_guard_b(0x42b40000,0x41600000,0x40400000,0,0,0,puVar10,puVar12,puVar11,1,1
                                 );
    Font_drawTextTransformed(local_74,(float)fVar3 * 0.5,uVar4,uVar5,uVar6,uVar7,uVar8,uVar9,puVar10,puVar12,
                 puVar11,uVar13,uVar14);
    local_8 = 0xffffffff;
    ...
    local_a0 = 0;
    uVar4 = 0x42b40000;
    fVar3 = (float10)security_cookie_guard_b(0x42b40000,0x41600000,0,0,0,0,puVar11,puVar10,puVar12,1,1);
