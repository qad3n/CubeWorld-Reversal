...

{
  ...
  uVar6 = 1;
  uVar5 = 0x41400000;
  itemWidth = (float)Widget_measureGuarded(0x41400000,1);
  labelWidth = (float)Widget_measureGuarded();
  Widget_setScroll(((float)itemWidth - (float)labelWidth) - 15.0f,uVar5,uVar6);
  Widget_setScroll(0x43700000,0x42280000,1);
  uVar6 = 1;
  uVar5 = 0x42280000;
  itemWidth = (float)Widget_measureGuarded(0x42280000,1);
  labelWidth = (float)Widget_measureGuarded();
  Widget_setScroll(((float)itemWidth - (float)labelWidth) - 15.0f,uVar5,uVar6);
  Widget_setScroll(0x43700000,0x42900000,1);
  uVar6 = 1;
  uVar5 = 0x42900000;
  itemWidth = (float)Widget_measureGuarded(0x42900000,1);
  labelWidth = (float)Widget_measureGuarded();
  Widget_setScroll(((float)itemWidth - (float)labelWidth) - 15.0f,uVar5,uVar6);
  Widget_setScroll(0x43700000,0x42cc0000,1);
  uVar6 = 1;
  uVar5 = 0x42cc0000;
  itemWidth = (float)Widget_measureGuarded(0x42cc0000,1);
  labelWidth = (float)Widget_measureGuarded();
  Widget_setScroll(((float)itemWidth - (float)labelWidth) - 15.0f,uVar5,uVar6);
  Widget_setScroll(0x43700000,0x43040000,1);
  uVar6 = 1;
  uVar5 = 0x43040000;
  itemWidth = (float)Widget_measureGuarded(0x43040000,1);
  labelWidth = (float)Widget_measureGuarded();
  Widget_setScroll(((float)itemWidth - (float)labelWidth) - 15.0f,uVar5,uVar6);
  Widget_setScroll(0x43700000,0x43220000,1);
  uVar6 = 1;
  uVar5 = 0x43220000;
  itemWidth = (float)Widget_measureGuarded(0x43220000,1);
  labelWidth = (float)Widget_measureGuarded();
  Widget_setScroll(((float)itemWidth - (float)labelWidth) - 15.0f,uVar5,uVar6);
  Widget_setScroll(0x43700000,0x43400000,1);
  uVar6 = 1;
  uVar5 = 0x43400000;
  itemWidth = (float)Widget_measureGuarded(0x43400000,1);
  labelWidth = (float)Widget_measureGuarded();
  Widget_setScroll(((float)itemWidth - (float)labelWidth) - 15.0f,uVar5,uVar6);
  Widget_setScroll(0x43700000,0x435e0000,1);
  uVar6 = 1;
  uVar5 = 0x435e0000;
  itemWidth = (float)Widget_measureGuarded();
  labelWidth = (float)Widget_measureGuarded();
  Widget_setScroll(((float)itemWidth - (float)labelWidth) - 15.0f,uVar5,uVar6);
  Widget_setScroll(0x43700000,0x437c0000,1);
  uVar6 = 1;
  uVar5 = 0x437c0000;
  itemWidth = (float)Widget_measureGuarded(0x437c0000,1);
  labelWidth = (float)Widget_measureGuarded();
  Widget_setScroll(((float)itemWidth - (float)labelWidth) - 15.0f,uVar5,uVar6);
  ...
  uVar6 = 1;
  uVar5 = 0x439c0000;
  itemWidth = (float)Widget_measureGuarded(0x439c0000,1);
  labelWidth = (float)Widget_measureGuarded();
  Widget_setScroll(((float)itemWidth - (float)labelWidth) - 15.0f,uVar5,uVar6);
  uVar5 = 1;
  itemWidth = (float)Widget_measure(1);
  labelWidth = (float)Widget_measure();
  Widget_setScroll(0x41a00000,((float)itemWidth - (float)labelWidth) - 20.0f,uVar5);
  itemWidth = (float)Widget_measureGuarded();
  uVar5 = 1;
  labelWidth = (float)Widget_measure(1);
  fVar3 = (float)Widget_measure();
  slotHeight = ((float)labelWidth - (float)fVar3) - 20.0f;
  labelWidth = (float)Widget_measureGuarded(slotHeight);
  Widget_setScroll((((float)itemWidth - 40.0f) - (float)labelWidth) * 0.5f + 20.0f,slotHeight,uVar5);
  itemWidth = (float)Widget_measureGuarded();
  uVar5 = 1;
  labelWidth = (float)Widget_measure(1);
  fVar3 = (float)Widget_measure();
  slotHeight = ((float)labelWidth - (float)fVar3) - 20.0f;
  labelWidth = (float)Widget_measureGuarded(slotHeight);
  Widget_setScroll(((float)itemWidth - 20.0f) - (float)labelWidth,slotHeight,uVar5);
  return;
}
