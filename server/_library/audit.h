...
void __cdecl walWriteFrames_inner(int *param_1,uint param_2,uint *param_3,int param_4,int param_5,uint param_6);
...
undefined4 __cdecl sqlite3_config(undefined4 param_1,undefined8 *param_2,undefined4 param_3,undefined4 param_4);
