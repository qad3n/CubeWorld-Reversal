...
float __thiscall World_roadField(void *param_1,uint param_2,uint param_3);
float __cdecl valueNoise2D(undefined4 param_1,undefined4 param_2,double param_3);
...
float __thiscall World_objectFalloffWeight(uint *param_1,uint *param_2,uint *param_3);
float __thiscall World_riverClimateGate(void *param_1,uint param_2,float param_3,int param_4);
void __thiscall World_waterDepthField(void *this,uint param_1,uint param_2);
float __thiscall World_falloffSquared(uint *param_1,uint *param_2,uint *param_3);
