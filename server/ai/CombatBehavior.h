...
float __thiscall Combat_getAbilityResourceCost(int param_1,undefined4 param_2,int param_3);
...
float __fastcall Combat_computeAttackSpeed(int param_1);
float __fastcall Combat_sumEquipAttackBonus(int param_1);
float __fastcall Combat_equipSpeedBonus(char *param_1);
